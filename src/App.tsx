              ...
              <div className="flex items-center justify-between gap-2 sm:gap-4">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 truncate">
                    <span className="hidden sm:inline">If Flowlyt helps you, consider starring the repo</span>
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-2 sm:px-3 py-1 bg-gray-200 dark:bg-slate-700 text-gray-900 dark:text-gray-100 rounded hover:bg-gray-300 dark:hover:bg-slate-600 transition-colors text-xs font-medium whitespace-nowrap"
                  >
              ...
              <nav className="flex items-center justify-center w-full sm:w-auto">
                <div 
                  className={`flex items-center bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-full border border-gray-200/60 dark:border-white/10 shadow-lg shadow-gray-200/50 dark:shadow-black/20 transition-all duration-300 ease-out ${
                    scrollY > 100 ? 'px-1.5 py-1.5 gap-0.5 sm:gap-1' : 'px-2 sm:px-4 py-2 sm:py-2.5 gap-1.5 sm:gap-4'
                  }`}
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2.5">
                    <div className={`bg-gradient-to-br from-emerald-300 to-cyan-400 rounded-lg flex items-center justify-center shadow-md transition-all duration-300 ${
                      scrollY > 100 ? 'w-5 h-5 sm:w-6 sm:h-6' : 'w-6 h-6 sm:w-8 sm:h-8'
                    }`}>
                      <GitBranch className={`text-slate-900 transition-all duration-300 ${scrollY > 100 ? 'w-2.5 h-2.5 sm:w-3 sm:h-3' : 'w-3 h-3 sm:w-4 sm:h-4'}`} />
                    </div>
                    <span className={`text-xs sm:text-lg font-semibold text-gray-900 dark:text-white transition-all duration-300 ${scrollY > 100 ? 'w-0 opacity-0' : 'w-auto opacity-100'}`} style={{ overflow: 'hidden', whiteSpace: 'nowrap' }}>Flowlyt</span>
                  </div>

                  {/* Divider */}
                  <div className={`h-4 sm:h-6 bg-gray-300/40 dark:bg-white/10 transition-all duration-300 ${scrollY > 100 ? 'w-0 opacity-0 mx-0' : 'w-px opacity-100'}`}></div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`text-xs sm:text-sm font-medium text-gray-900 dark:text-white hover:bg-gray-100/80 dark:hover:bg-white/10 rounded-full transition-all inline-flex items-center ${
                      scrollY > 100 ? 'px-1.5 sm:px-2 py-1.5 sm:py-2 gap-0.5' : 'px-2 sm:px-4 py-1.5 sm:py-2 gap-1 sm:gap-2'
                    }`}
                  >
                    <svg className={`flex-shrink-0 transition-all duration-300 ${scrollY > 100 ? 'w-3 h-3 sm:w-3.5 sm:h-3.5' : 'w-3 h-3 sm:w-4 sm:h-4'}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`text-xs sm:text-sm font-medium text-gray-900 dark:text-white bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 hover:from-emerald-500/30 hover:to-cyan-500/30 rounded-full transition-all inline-flex items-center border border-emerald-500/30 shadow-sm ${
                      scrollY > 100 ? 'px-1.5 sm:px-2 py-1.5 sm:py-2 gap-0.5' : 'px-2 sm:px-4 py-1.5 sm:py-2 gap-1 sm:gap-2'
                    }`}
                  >
                    <Github className={`flex-shrink-0 transition-all duration-300 ${scrollY > 100 ? 'w-3 h-3 sm:w-3.5 sm:h-3.5' : 'w-3 h-3 sm:w-4 sm:h-4'}`} />
